                    ...
                    <?php
                        ...
                        while($row = mysqli_fetch_array($result)) { ?>
                            <div class="col category">
                                        <a class="text-decoration-none" href="../php/DetailProd.php?id=<?= $row['id'] ?>&name=<?= urlencode($row['name']) ?>&price=<?= $row['price'] ?>">
                                            <img width="200" height="200" src="<?= $row['image'] ?>" title="<?= $row['name'] ?>" /></a>
                                            <div><a class="text-decoration-none" href="../php/DetailProd.php?id=<?= $row['id'] ?>&name=<?= urlencode($row['name']) ?>&price=<?= $row['price'] ?>">
