...
<head>
    ...
    <title>noshoesnoprotection/giay-bitas-nu</title>
            ...
            <div class="product py-1">
                <div class="row  text-md-center">
                    <div class="row">
                        ...
                        <div class="col brand-h bg-light text-uppercase text-danger">GIÀY BITAS NỮ</div>
                        <script>
                        function check() 
                        {
                            window.alert("Xin hãy đăng nhập!");
                    ...
                    <div class="row products">  
                        ...
                        $products = mysqli_query($conn, "SELECT * FROM `product` ORDER BY `id` ASC LIMIT 10 OFFSET 50");
